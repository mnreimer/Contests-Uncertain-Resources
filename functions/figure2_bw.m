...
g = figure('Name','Nash Equilibrium Lobbying Efforts by Treatment',...
  ...
  % Create axes 
    ...
    hold(axes1,'on');
    sub = plot(theta',[y(:,1,1),y(:,2,1),y(:,3,1),y(:,3,1)],'LineWidth',2.5,...
        'Color','black'); 
    grid on;
    set(sub,{'LineStyle'},{'--',':','-.','-'}');
  ...
  % Create axes 
    ...
    hold(axes2,'on');
    sub = plot(theta',[y(:,1,2),y(:,2,2),y(:,3,2),y(:,3,2)],'LineWidth',2.5,...
        'Color','black'); 
    grid on;
    set(sub,{'LineStyle'},{'--',':','-.','-'}');
    xlabel('CRRA (\theta)'); ylabel('Lobby Effort (L)');
  ...
  % Create axes 
    ...
    hold(axes3,'on');
   sub = plot(theta',[y(:,1,3),y(:,2,3),y(:,3,3),y(:,3,3)],'LineWidth',2.5,...
        'Color','black'); 
    grid on;
    set(sub,{'LineStyle'},{'--',':','-.','-'}');
    xlabel('CRRA (\theta)'); ylabel('Lobby Effort (L)');
  ...
  % Create axes 
    ...
    hold(axes4,'on');
    sub1 = plot(theta',[y(:,1,4),y(:,2,4),y(:,3,4)],'LineWidth',2.5,...
        'Color','black'); grid on;
    set(sub1,{'LineStyle'},{'--',':','-.'}');
    xlabel('CRRA (\theta)'); ylabel('Lobby Effort (L)');
    ylim([0 30])
  ...
  % Create axes 
    ...
    hold(axes5,'on');
    sub1 = plot(theta',[y(:,1,5),y(:,2,5),y(:,3,5)],'LineWidth',2.5,...
        'Color','black'); grid on;
    set(sub1,{'LineStyle'},{'--',':','-.'}');
    xlabel('CRRA (\theta)'); ylabel('Lobby Effort (L)');
    ylim([0 30])
  ...
  % Create axes 
    ...
    hold(axes6,'on');
    sub1 = plot(theta',[y(:,1,6),y(:,2,6),y(:,3,6)],'LineWidth',2.5,...
        'Color','black'); grid on;
    set(sub1,{'LineStyle'},{'--',':','-.'}');
    xlabel('CRRA (\theta)'); ylabel('Lobby Effort (L)');
    ylim([0 30])
